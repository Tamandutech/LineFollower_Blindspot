...
const int SensorAnalog1 = A7;  // Analog input pin that the potentiometer is attached to
const int SensorAnalog2 = A6; // Analog output pin that the LED is attached to
